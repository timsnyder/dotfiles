...
" Author:       Alex Jakushev (Alex.Jakushev@kemek.lt)
" Last Change:	tsnyder 06-Nov-05 17:05 

" Parameters
" ==========
" enable folding of everything outside the conflict 
...
" Unset cvs_cnfl_fold if it set but vim doesn't support it.
if version < 600 && exists("cvs_cnfl_fold")
  unlet cvs_cnfl_fold
endif
