" Vim syntax file
" Language:		C-shell (tcsh) syntax bugfix 'after' file
" Maintainor:		Tim Snyder 
" Last Modified:	tsnyder 01-Jul-06 11:46 
"
...
syn match tcshModifier		contained '\v:(ag|ga|a|g)?[htreuls&qx]' nextgroup=@tcshModifiers
"
"" ----- Operators / Specials -----
